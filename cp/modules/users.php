    ...
    //  $offset = ($currentpage - 1) * $rowsperpage;
     $data = DB::getInstance()->run_sql("SELECT users.*, state.name AS state_name FROM users INNER JOIN state ON (users.state_id = state.id) WHERE users.is_verified = 1 ORDER BY users.id desc ");  ?>
