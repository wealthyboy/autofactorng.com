<form role="form" method="POST" action="modules/update_wheels.php" enctype="multipart/form-data">
  ...
  <div class="box-body">
    ...
    <div class="row">
      <div class="col-md-4">
        <div class="form-group">
          <?php
            $data = mysqli_query($GLOBALS['dbc'], "SELECT * FROM wheels WHERE id = $prod_id");
      ...
      <div class="col-md-4">
        <div class="form-group">
          <label>Rim Size</label>
          <input type="text" class="form-control" name="rim-size" value="<?php echo $row['rim']; ?>" />
        </div>
      </div>
      <div class="col-md-4">
        <div class="form-group">
