<form role="form" method="POST" action="modules/add_batteries.php" enctype="multipart/form-data">
  <div class="box-body">
    <div class="row">
      <div class="col-md-3">
    ...
    <div class="row">
      <div class="col-md-3">
        <div class="form-group">
          ...
          <input type="text" class="form-control" name="prod-volt" />
        </div>
      </div>
      <div class="col-md-3">
        <div class="form-group">
          <label>Product Ampere</label>
          <input type="text" class="form-control" name="prod-amp" />
        </div>
      </div>
      <div class="col-md-3">
        <div class="form-group">
