<form role="form" method="POST" action="modules/update_tyres.php" enctype="multipart/form-data">
  ...
  <div class="box-body">
    <div class="row">
      <div class="col-md-3">
       ...
       <?php
            $data = mysqli_query($GLOBALS['dbc'], "SELECT * FROM tyres WHERE id = $prod_id");
    ...
    <div class="row">
      <div class="col-md-3">
        <div class="form-group">
          ...
          <input type="text" class="form-control" name="prod-radius" value="<?php echo $row['radius']; ?>" />
        </div>
      </div>
      <div class="col-md-3">
        <div class="form-group">
          <label>Product Width</label>
          <input type="text" class="form-control" name="prod-width" value="<?php echo $row['width']; ?>" />
        </div>
      </div>
      <div class="col-md-3">
        <div class="form-group">
          <label>Product Height</label>
          <input type="text" class="form-control" name="prod-height" value="<?php echo $row['height']; ?>" />
        </div>
      </div>
    </div><!--row-->
    <div class="row">
