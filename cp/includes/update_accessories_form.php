...
<?php 
   if (Input::exists('post') && Input::get('product_id') ) {
       if( RelatedProducts::getInstance()->destroy(Input::get('product_id'))){
          return 1;
       }else{
           return 0;
       }
 ...
 ?>
<form role="form" method="POST" action="modules/update_accessories.php" enctype="multipart/form-data">
  ...
  <div class="box-body">
    <div class="row">
      <div class="col-md-3">
       ...
       <?php
            $data = mysqli_query($GLOBALS['dbc'], "SELECT * FROM accessories WHERE id = $prod_id");
