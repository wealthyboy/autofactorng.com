<form role="form" method="POST" action="modules/update_car_care.php" enctype="multipart/form-data">
  ...
  <div class="box-body">
    <div class="row">
      <div class="col-md-3">
       ...
       <?php
            $data = mysqli_query($GLOBALS['dbc'], "SELECT * FROM car_care WHERE id = $prod_id");
