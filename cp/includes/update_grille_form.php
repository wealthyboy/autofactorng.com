<form role="form" method="POST" action="modules/update_grille.php" enctype="multipart/form-data">
  ...
  <div class="box-body">
    ...
    <div class="row">
      <div class="col-md-3">
        <div class="form-group">
          <?php
            $data = mysqli_query($GLOBALS['dbc'], "SELECT * FROM grille_guards WHERE id = $prod_id");
