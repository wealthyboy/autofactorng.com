<form role="form" method="POST" action="modules/update_batteries.php" enctype="multipart/form-data">
  ...
  <div class="box-body">
    <div class="row">
      <div class="col-md-3">
       ...
       <?php
            $data = mysqli_query($GLOBALS['dbc'], "SELECT * FROM batteries WHERE id = $prod_id");
      ...
      <div class="col-md-3">
        <div class="form-group">
          ...
          <input type="text" class="form-control" 
             value="<?php echo $row['image_alt_text']; ?>"
          name="image_alt_text" />
        </div>
      </div>
    </div> <!--row-->
    <div class="row">
      <div class="col-md-3">
        <div class="form-group">
          ...
          <label>Product Voltage</label>
          <input type="text" class="form-control" name="prod-volt" value="<?php echo $row['volts']; ?>" />
        </div>
      </div>
      <div class="col-md-3">
        <div class="form-group">
          <label>Product Ampere</label>
          <input type="text" class="form-control" name="prod-amp" value="<?php echo $row['ampere']; ?>" />
        </div>
      </div>
      <div class="col-md-3">
        <div class="form-group">
