<form role="form" method="POST" action="modules/update_servicing.php" enctype="multipart/form-data">
  ...
  <div class="box-body">
    <div class="row">
      <div class="col-md-3">
        <div class="form-group">
          ...
          <?php
            $data = mysqli_query($GLOBALS['dbc'], "SELECT * FROM product_sub_cats WHERE cat_id = $cat_id LIMIT 2");
            while($row = mysqli_fetch_array($data)) { ?>
              <option value="<?php echo $row['name']; ?>"><?= $row['name']; ?></option>
          <?php } ?>
            <optgroup label="Spark Plugs">
              <option value="Denso Iridium Power Spark Plug">Denso Iridium Power Spark Plug</option>
              <option value="NGK G Power Platinum Spark Plug">NGK G Power Platinum Spark Plug</option>
              <option value="NGK Standard Copper Plug">NGK Standard Copper Plug</option>
              <option value="Bosch Platinum Spark Plug">Bosch Platinum Spark Plug</option>
              <option value="Kia/Hyundai Plug">Kia/Hyundai Plug</option>
              <option value="Motorcraft Platinum Plug">Motorcraft Platinum Plug</option>
            </optgroup>
          </select>
        </div>
      </div>
    ...
    <div class="row">
      <div class="col-md-3">
        <div class="form-group">
          <?php
            $data = mysqli_query($GLOBALS['dbc'], "SELECT * FROM servicing_parts WHERE id = $prod_id");
