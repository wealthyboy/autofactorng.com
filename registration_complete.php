  ...
  <div id="signup_wrapp">
	    <div id="signup_header">
			    <a href="http://autofactorng.com" alt="LINK: HOME" title="<< Go back to homepage"><img src="/images/afng_logo.png"></a>
			     ...
			     <h3 style="color: #777;">Account Registration: Step 2</h3>
			   <hr />
		   <h3 style="color: #777;"><p class="pass">You almost there, please verify your email .An email has been to <?php echo $verify_email  ?></p></h3>
	   <hr />
